...
// node_modules/uppercase-first/uppercase-first.js
var require_uppercase_first = __commonJS({
  "node_modules/uppercase-first/uppercase-first.js"(exports, module2) {
    var ucFirst2 = function() {
      "use strict";
      function make(str) {
        str = str || "";
    ...
    if (typeof module2 === "object" && module2.exports) {
      module2.exports = ucFirst2;
    }
  }
});

// .next/required-server-files.json
var require_required_server_files = __commonJS({
  ".next/required-server-files.json"(exports, module2) {
    module2.exports = { version: 1, config: { env: {}, webpack: null, webpackDevMiddleware: null, eslint: { ignoreDuringBuilds: false }, typescript: { ignoreBuildErrors: false, tsconfigPath: "tsconfig.json" }, distDir: ".next", cleanDistDir: true, assetPrefix: "", configOrigin: "next.config.js", useFileSystemPublicRoutes: true, generateEtags: true, pageExtensions: ["tsx", "ts", "jsx", "js"], target: "server", poweredByHeader: true, compress: true, analyticsId: "", images: { deviceSizes: [640, 750, 828, 1080, 1200, 1920, 2048, 3840], imageSizes: [16, 32, 48, 64, 96, 128, 256, 384], path: "/_next/image", loader: "default", domains: [], disableStaticImages: false, minimumCacheTTL: 60, formats: ["image/webp"], dangerouslyAllowSVG: false, contentSecurityPolicy: "script-src 'none'; frame-src 'none'; sandbox;", remotePatterns: [], unoptimized: false }, devIndicators: { buildActivity: true, buildActivityPosition: "bottom-right" }, onDemandEntries: { maxInactiveAge: 15e3, pagesBufferLength: 2 }, amp: { canonicalBase: "" }, basePath: "", sassOptions: {}, trailingSlash: false, i18n: null, productionBrowserSourceMaps: false, optimizeFonts: true, excludeDefaultMomentLocales: true, serverRuntimeConfig: {}, publicRuntimeConfig: {}, reactStrictMode: true, httpAgentOptions: { keepAlive: true }, outputFileTracing: true, staticPageGenerationTimeout: 60, swcMinify: false, output: "standalone", experimental: { optimisticClientCache: true, manualClientBasePath: false, legacyBrowsers: true, browsersListForSwc: false, newNextLinkBehavior: false, cpus: 9, sharedPool: true, profiling: false, isrFlushToDisk: true, workerThreads: false, pageEnv: false, optimizeCss: false, nextScriptWorkers: false, scrollRestoration: false, externalDir: false, disableOptimizedLoading: false, gzipSize: true, swcFileReading: true, craCompat: false, esmExternals: true, appDir: false, isrMemoryCacheSize: 52428800, serverComponents: false, fullySpecified: false, outputFileTracingRoot: "", swcTraceProfiling: false, forceSwcTransforms: false, largePageDataBytes: 128e3, adjustFontFallbacks: false, trustHostHeader: false }, configFileName: "next.config.js" }, appDir: "/Users/neel.patel/Desktop/Neel/nextProject/next-advanced-apollo-starter", files: [".next/routes-manifest.json", ".next/server/pages-manifest.json", ".next/build-manifest.json", ".next/prerender-manifest.json", ".next/server/middleware-manifest.json", ".next/react-loadable-manifest.json", ".next/server/font-manifest.json", ".next/BUILD_ID"], ignore: ["node_modules/next/dist/compiled/@ampproject/toolbox-optimizer/**/*"] };
  }
});

// neel.js
var _ = require_lodash();
var ucFirst = require_uppercase_first();
function neel_default() {
  let name = "neel";
  name = _.toUpper(name);
...
var next = require("next/dist/server/next-server").default;
var _2 = require_lodash();
console.log("Custom server started!!");
var dev = process.env.NODE_ENV !== "production";
var hostname = "localhost";
var port = 3e3;
var conf = require_required_server_files().config;
var app = new next({ dev, hostname, port, conf });
var handle = app.getRequestHandler();
app.prepare().then(() => {
  createServer(async (req, res) => {
    try {
      const parsedUrl = parse(req.url, true);
      const answer = _2.partition([1, 2, 3, 4], (n) => n % 2);
      console.log(answer);
      neel_default();
